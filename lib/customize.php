...
$wp_customize->add_section( 'Images', array(
    ...
    'description' => esc_html__( 'Add images here' ),
    'priority' => 10,
    'capability' => 'edit_theme_options',
  ) );

  $wp_customize->add_setting('identitydental_header_img', array(
    'default' => '',
    'sanitize_callback' => 'sanitize_text_field',
));

  $wp_customize->add_control('identitydental_header_img', array(
    'type' => 'text',
    'label' => esc_html__('Header Image', 'identitydental'),
    'section' => 'Images',
